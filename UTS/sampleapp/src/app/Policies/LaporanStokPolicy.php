...
class LaporanStokPolicy
{
    ...
    {
        return $user->can('view_any_laporan::stok');
    }
    ...
    {
        return $user->can('view_laporan::stok');
    }
    ...
    {
        return $user->can('create_laporan::stok');
    }
    ...
    {
        return $user->can('update_laporan::stok');
    }
    ...
    {
        return $user->can('delete_laporan::stok');
    }
    ...
    {
        return $user->can('delete_any_laporan::stok');
    }
     ...
     */
    public function replicate(User $user, LaporanStok $laporanStok): bool
    {
